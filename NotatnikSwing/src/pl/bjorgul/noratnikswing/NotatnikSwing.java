package pl.bjorgul.noratnikswing;
...
public class NotatnikSwing extends JFrame implements ActionListener {
	...
	public NotatnikSwing() {
		setTitle("Notatnik w SWING");
		setSize(800, 600);
	...
	public static void main(String[] args) {
		NotatnikSwing appMenu = new NotatnikSwing();
